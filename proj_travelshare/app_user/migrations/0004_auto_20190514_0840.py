...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='program',
            name='duration',
            field=models.CharField(choices=[('Less than 2 hours', 'Less than 2 hours'), ('2 to 4 hours', '2 to 4 hours'), ('4 to 8 hours', '4 to 8 hours'), ('More than 8 hours', 'More than 8 hours')], max_length=20),
        ),
        migrations.AlterField(
            model_name='program',
            name='frequency',
            field=models.CharField(choices=[('Once', 'Once'), ('Multiple', 'Multiple'), ('Fexible', 'Fexible')], max_length=10),
        ),
        migrations.AlterField(
            model_name='program',
            name='type',
            field=models.CharField(choices=[('Course', 'Course'), ('Consultation', 'Consultation'), ('Lecture', 'Lecture'), ('Show', 'Show'), ('Talk', 'Talk'), ('Workshop', 'Workshop'), ('Others', 'Others')], max_length=10),
        ),
        migrations.AlterField(
            model_name='trip',
            name='destination',
